...
export const VARIABLE_STAR_TARGET_ADU_MIN = 0.4
export const VARIABLE_STAR_TARGET_ADU_DEFAULT = 0.5
export const VARIABLE_STAR_TARGET_ADU_SMALL = 0.6
export const VARIABLE_STAR_TARGET_ADU_MEDIUM = 0.5
 ...
 * is less likely to saturate at maximum. Floor at 0.4.
 *
 * - amp &lt; 0.4 mag → 0.60
 * - 0.4–0.8 → 0.50
 * - ≥ 0.8 (or unknown) → 0.40 / 0.50 default
 */
