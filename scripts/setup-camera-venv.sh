...
echo "  ${VENV}/bin/python3 ${ROOT}/observatory/camera_service.py"
echo "  (or ${ROOT}/camera_service.py — legacy launcher)"
echo ""
echo "Example systemd ExecStart:"
echo "  ExecStart=${VENV}/bin/python3 ${ROOT}/observatory/camera_service.py"
