# Pomfret Astro — Personal Hub

Embedded local API server for **Personal Edition**. Runs on the observatory PC (or dev machine) at **`http://127.0.0.1:7841`**.

The Control Client and Station Agent talk to this Hub — not pomfretastro.org.

## Quick start

```bash
cd general-platforms/personal/hub
npm install
npm run dev
```
...
| OS | Path |
|----|------|
| macOS / Linux | `~/.pomfretastro/personal-hub/` |
| Windows | `%LOCALAPPDATA%\PomfretAstro\PersonalHub\` |
