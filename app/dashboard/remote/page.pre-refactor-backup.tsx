/**
 * READ-ONLY backup of app/dashboard/remote/page.tsx before Remote modularization (v6.2.5 → v6.2.6).
 * Snapshot from git 1735459 (5387 lines). Not imported by the app — reference / rollback aid only.
 */
'use client'
