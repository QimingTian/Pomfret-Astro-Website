# Pomfret Astro — Personal Station Agent
...
`agent/nina_agent.py` — polls Personal Hub (`POMFRET_HUB_BASE_URL`), starts NINA, optional R2 upload.
...
- Windows: `%LOCALAPPDATA%\PomfretAstro\Station\station-config.json`
- macOS (dev): `~/.pomfretastro/station/station-config.json`
...
```text
src-tauri\target\release\bundle\nsis\Pomfret Astro Station_0.1.0_x64-setup.exe
```
